...
func SendEmail(target string) string {
	...
	mailConf.Title = "【简历模板定制】您的电子邮箱验证码。"
...
func EmailVerfication(c *gin.Context) {
	var data EmailData
	...
	vcode := SendEmail(data.Email)
	utility.Response(http.StatusOK, "OK", gin.H{"verification_code": vcode}, c)
}
